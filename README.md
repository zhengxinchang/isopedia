...
|----|----|-----------|-----|------| -----|-----|-----|
|isopedia_index_hs_v1.0| Homo sapiens| GRCh38| Download ftp://hgsc-sftp1.hgsc.bcm.tmc.edu//rt38520/isopedia_index_hs_v1.0.tar.xz MD5SUM: ftp://hgsc-sftp1.hgsc.bcm.tmc.edu//rt38520/isopedia_index_hs_v1.0.tar.xz.md5|1,007|305G(107G)|16Gb|107 ENCODE samples + 900 SRA samples|
